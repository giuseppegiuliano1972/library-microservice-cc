package com.ls.library.repository;
...
public interface LendingDao extends JpaRepository <Lending,Long> {
	...
	@Query(value = "SELECT l FROM Lending l where l.returnDate is null and l.idBook = ?1")
	public Lending findByIdBookAndReturnDateNull(Long idBook);
